package com.miltonvaz.voltio1.features.products.di.navigation
    ...
    override fun registerGraph(
        ...
        navGraphBuilder.composable<UserHome> {
            ...
            HomeScreenClient(
                ...
                onCompanyClick = { companyId -> navController.navigate(CompanyProfileArg(companyId = companyId)) }
            )
        }
        ...
        navGraphBuilder.composable<CompanyProfileArg> { backStackEntry ->
            val args = backStackEntry.toRoute<CompanyProfileArg>()
