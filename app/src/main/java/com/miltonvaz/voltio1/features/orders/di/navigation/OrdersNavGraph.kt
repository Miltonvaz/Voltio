...
import com.miltonvaz.voltio1.features.orders.presentation.viewmodel.UserOrdersViewModel
...
class OrdersNavGraph @Inject constructor() : FeatureNavGraph {
    override fun registerGraph(
        ...
        navGraphBuilder.composable<Checkout> {
            ...
            val checkoutUiState by checkoutViewModel.uiState.collectAsStateWithLifecycle()
            val totalAmount = cartUiState.cartItems.sumOf { it.product.price * it.quantity }
