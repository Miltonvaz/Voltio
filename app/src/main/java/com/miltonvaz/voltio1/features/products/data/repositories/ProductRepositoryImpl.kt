package com.miltonvaz.voltio1.features.products.data.repositories

import com.miltonvaz.voltio1.features.products.data.datasource.remote.ProductApiService
...
import com.miltonvaz.voltio1.features.products.domain.repositories.IProductRepository
...
class ProductRepositoryImpl @Inject constructor(
    ...
    override suspend fun createProduct(
        ...
        val empresaPart = request.id_empresa?.toString()?.toRequestBody("text/plain".toMediaTypeOrNull())
